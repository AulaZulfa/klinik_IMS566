...
<div class="row">
	<div class="col-md-9 border-end">
		...
		<div class="d-none d-sm-block">
			<div class="activity-container">
				<div class="image-container img-one">
					<?= $this->Html->image('header/vaccines.gif', ['alt' => 'vaccines']); ?>
				</div>
				<div class="image-container img-two">
					<?= $this->Html->image('header/bandage.gif', ['alt' => 'bandage']); ?>
				</div>
				<div class="image-container img-three">
					<?= $this->Html->image('header/workers.gif', ['alt' => 'workers']); ?>
				</div>
				<div class="image-container img-four">
					<?= $this->Html->image('header/doctor.gif', ['alt' => 'doctor']); ?>
				</div>
				<div class="image-container img-five">
					<?= $this->Html->image('header/medic.gif', ['alt' => 'medic']); ?>
				</div>
				<div class="image-container img-six">
					<?= $this->Html->image('header/hati2.gif', ['alt' => 'hati2']); ?>
				</div>
			</div>
		</div>
		...
		<div class="row px-2 mb-4">
			<div class="col-md-4 border rounded-start pt-3 pb-3 bg-body-tertiary">
				<span class="fs-3"><?php echo $total_patients; ?> <i class="fa-solid fa-caret-up text-primary"></i></span><br />
				Total Patients
			</div>
			<div class="col-md-4 border rounded-start pt-3 pb-3 bg-body-tertiary">
				<span class="fs-3"><?php echo $total_doctors; ?> <i class="fa-solid fa-caret-up text-primary"></i></span><br />
				Total Doctors
			</div>
			<div class="col-md-4 border rounded-start pt-3 pb-3 bg-body-tertiary">
				<span class="fs-3"><?php echo $total_appointments; ?> <i class="fa-solid fa-caret-up text-primary"></i></span><br />
				Total Appointments
			</div>
		</div>
		...
		<div class="collapse show" id="chartCollapse">
			<div class="row mb-4">
				<div class="col-md-3 ps-2">
					<div class="am" data-waffly-title="Doctor Am" data-waffly-value="<?php echo $doctor_percent['am'];?>%">
						<div class="title">Doctor Am</div>
							<meter class="users" value="<?= $doctor_percent['am'] ?>"
               				max="100"></meter>
						</div>
				</div>

				<div class="col-md-3 ps-2">
					<div class="gigi" data-waffly-title="Doctor Gigi" data-waffly-value="<?php echo $doctor_percent['gigi']; ?>%">
						<div class="title">Doctor Gigi</div>
							<meter class="users" value="<?= $doctor_percent['gigi'] ?>"
               				max="100"></meter>
						</div>
				</div>

				<div class="col-md-3 ps-2">
					<div class="kulit" data-waffly-title="Doctor Kulit" data-waffly-value="<?php echo $doctor_percent['kulit']; ?>%">
						<div class="title">Doctor Kulit</div>
							<meter class="users" value="<?= $doctor_percent ['kulit']?>"
               				max="100"></meter>
						</div>
				</div>

				<div class="col-md-3 ps-2">
					<div class="wanita" data-waffly-title="Doctor Wanita & Kandungan" data-waffly-value="<?php echo $doctor_percent['wanita']; ?>%">
						<div class="title">Doctor Wanita</div>
							<meter class="users" value="<?= $doctor_percent ['wanita']?>"
               				max="100"></meter>
						</div>
				</div>
			</div>
		...
		<div class="row mt-4 justify-content-center">
			...
			<!-- TOP VISIT REASONS -->
			<div class="col-md-6">
				<div class="chart-wrap bg-light p-3 rounded shadow-sm" style="height:350px;">
					<h5 class="text-center mb-3 text-dark fw-semibold">Top Visit Reasons</h5>
					<canvas id="topVisitChart"></canvas>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="chart-wrap bg-light p-3 rounded shadow-sm" style="height:350px;">
					<h5 class="text-center mb-3 text-dark fw-semibold">Appointment Status</h5>
		...
		TOP VISIT REASONS
		======================= */
		const topVisitCtx = document.getElementById('topVisitChart');

		new Chart(topVisitCtx, {
			type: 'bar',
			data: {
				labels: [
					'Fever / Flu',
		...
		<div class="card bg-body-tertiary border-0 shadow mb-3">
			<div class="card-body text-body-secondary">
				...
				At <?= $system_abbr; ?> Clinic, we are dedicated to providing high-quality medical care to our community. With a team of experienced healthcare professionals and modern diagnostic tools, we offer a comprehensive range of services—from routine check-ups and vaccinations to acute illness treatment. We believe in a patient-centered approach, ensuring that every individual receives personalized attention in a comfortable and safe environment. Your journey to wellness starts here.
