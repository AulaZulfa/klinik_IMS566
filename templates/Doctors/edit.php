	...
	<div class="col-2 text-end">
		<div class="dropdown mx-3 mt-2">
            ...
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $doctor->id), 'class' => 'dropdown-item', 'escapeTitle' => false]
            ) ?>
            <?= $this->Html->link(__('List Doctors'), ['action' => 'index'], ['class' => 'dropdown-item', 'escapeTitle' => false]) ?>
				</div>
		</div>
    </div>
</div>
...
<div class="card rounded-0 mb-3 bg-body-tertiary border-0 shadow">
    <div class="card-body text-body-secondary">
           ...
           <div class="row">
                <div class="col-md-6">
                    <?php echo $this->Form->control('name',['label'=>'Dr. Name']); ?>
                </div>
                <div class="col-md-6">
